...
data_path = "E:\\Task\\Intelligent Technology in Manufacturing System\\Work3\\算例\\ta01.xlsx"#文件的位置要修改一下

times, machines = load_data(data_path)

best_C_max, best_sol, machine_start_time, machine_end_time, C_max_list = JS_GA(func=cal_Cmax,machines=machines,times=times,Max_iter=1000,dynamic_change=True,TLBO=True)  #记得改这里，要修改次数
...
writer = pd.ExcelWriter('Solution_ta01_1000_change.xlsx')#文件的名字也要改下最好把运行次数也加到文件里去
